...
<div id="main">
	<table class="content_view"  cellpadding="0" cellspacing="0" border="1">
		<form action="amodify.doa" method="post">
			...
			<tr>
				<td id="head">사진</td>
				<td><input type="text" name="filename" value="${content_view.filename}"></td>
			</tr>
			<tr>
				<td id="head">품종</td>
			...
			<tr>
				<td colspan="2">
					...
					<a href="adelete.doa?bId=${acontent_view.aId}">삭제하기</a>&nbsp; &nbsp; &nbsp;
					<a href="alist.doa">목록보기</a>&nbsp; &nbsp; &nbsp;
					<a href="areply_view.doa?bId=${acontent_view.aId}">답변</a>&nbsp; &nbsp; &nbsp;
