...
<table class="reply_view" width="500" cellpadding="0" cellspacing="0" border="1">
	<form action="areply.doa" method="post">
		<input type="hidden" name="aId" value="${areply_view.aId}">
		<input type="hidden" name="aGroup" value="${areply_view.aGroup}">
		<input type="hidden" name="aIndent" value="${areply_view.aIndent}">
		<input type="hidden" name="aStep" value="${areply_view.aStep}">
		<tr>
			<td id="head">번호</td>
		...
		<tr>
			<td id="head">품종</td>
			<td><input type="text" name="abreed" value="${areply_view.abreed}"></td>
		</tr>
		<tr>
			<td id="head">나이</td>
			<td><input type="text" name="aage" value="${areply_view.aage}"></td>
		</tr>
		<tr>
			<td id="head">성별</td>
			<td><input type="text" name="agender" value="${areply_view.agender}"></td>
		</tr>
		<tr>
			<td id="head">위치</td>
			<td><input type="text" name="alocation" value="${areply_view.alocation}"></td>
		</tr>
		<tr>
			<td colspan="2">
			<input type="submit" value="답변"> &nbsp;&nbsp;
			<a href="alist.doa">목록</a>
			</td>
		</tr>
	</form>
</table>
