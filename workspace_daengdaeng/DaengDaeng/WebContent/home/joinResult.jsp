...
<div id="header">
	...
	<ul>
		...
		<ul id="subMenu">
			<li id="subMenu_li"><a href="login.html" id="portfolio-link" class="skel-layers-ignoreHref"><img src="icons/write_gray.png"/>댕댕이 일정</a></li>
...
<div id="main">
	회원가입이 정상 처리되었습니다.<br>
	<br>
	<a href="login.html"><button class="btn_sm">로그인</button>
</div>
