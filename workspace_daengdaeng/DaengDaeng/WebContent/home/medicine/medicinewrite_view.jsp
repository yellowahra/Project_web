...
<div id="main">
	<div align="center">
		...
		<a href="#" onclick="window.open('medicineinfo.jsp', 'name', 'resizable= no width=700px height=800px'); return false" 
				style="margin-left:10%;"><img src="../icons/info.png"/>약 복용 관련 정보</a>&nbsp; &nbsp; &nbsp;<br><br><br>
	</div>
	...
	<%= dnamem %>
	<div>
	<table class="mwrite_view" cellpadding="0" cellspacing="0" style="margin-right:auto; margin-left:auto; width: 60%; font-size: 20pt;" >
